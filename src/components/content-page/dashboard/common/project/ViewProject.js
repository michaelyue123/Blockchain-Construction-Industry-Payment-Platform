...
const columns = [
  ...
  { id: 'projectName', label: 'Project Name', minWidth: 135 },
  {
    id: 'projectLead',
    label: 'Project Lead',
    minWidth: 135
...
function createData(number, projectName, projectLead, startDate, endDate, projectAmount) {
  return { number, projectName, projectLead, startDate, endDate, projectAmount };
}
...
const ViewProject = () => {
  ...
  return (
    <Paper className={classes.root}>
      <CardHeader title="Project List" className={classes.title} style={{backgroundColor: 'grey'}} titleTypographyProps={{variant:'h4' }} />
      <Divider />
